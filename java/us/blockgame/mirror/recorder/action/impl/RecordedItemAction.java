...
public class RecordedItemAction extends RecordedAction {

    @Setter @Getter private ItemStack itemStack;

    public RecordedItemAction(ItemStack itemStack, Location location, RecordedActionType recordedActionType) {
